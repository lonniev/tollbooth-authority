"""TheBrainVault — VaultBackend implementation via direct httpx calls.

Self-contained: no thebrain_mcp dependency. Uses TheBrain Cloud API
to persist operator tax ledgers in the same daily-child pattern as
PersonalBrainVault.
"""
...
class TheBrainVault:
    """Operator tax ledger persistence via TheBrain Cloud API.
